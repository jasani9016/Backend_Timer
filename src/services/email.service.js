        ...
        <body>
            <div class="pg_template_email">
                ...
                <div class="pg_template_content">
                    ...
                    <p>Leave Type: <span>${leaveData?.leaveType ?? "-"}</span></p>
                    <p>Half Type: <span>${leaveData?.halfType ?? "-"}</span></p>
                    <p>Start Date: <span>${moment(leaveData.startDate).format('DD-MM-YYYY')}</span></p>
                    <p>End Date: <span>${moment(leaveData.endDate).format('DD-MM-YYYY')}</span></p>
                    <p>Reason: <span>${leaveData.reason}</span></p>
                    <p>Status: <span>${leaveData.status}</span></p>
